...
if __name__ == "__main__":
    # Process the original questions
    process_csv("workwithisland_questions.csv", "workwithisland_questions_with_responses.csv")
    
    # Uncomment to process other question sets
    # process_csv("workwithisland_questions_personas.csv", "workwithisland_questions_personas_with_responses.csv")
    # process_csv("workwithisland_questions_countries.csv", "workwithisland_questions_countries_with_responses.csv") 